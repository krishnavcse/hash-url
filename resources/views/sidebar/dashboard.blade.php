<aside class="col-12 col-md-2 p-0 bg-dark flex-shrink-1">
    <nav class="navbar navbar-expand navbar-dark bg-dark flex-md-column flex-row align-items-start py-2">
        <div class="collapse navbar-collapse ">
            <ul class="flex-md-column flex-row navbar-nav w-100 justify-content-between">
                ...
                <li class="nav-item {{ basename($_SERVER['REQUEST_URI']) == 'hashed-urls' ? 'active' : '' }}">
                    <a class="nav-link pl-0" href="{{ route('hashed-urls') }}"><i class="fa fa-cog fa-fw"></i> <span class="d-none d-md-inline">Hashed URLs</span></a>
                </li>
                <li class="nav-item">
    ...
    <div style="margin-top:10px; text-align:center;">
        <img src="{{asset('images/hashurl.jpg')}}" alt="URL Shortener" height="50px">	
    </div>
</aside>